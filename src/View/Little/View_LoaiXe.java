 ...
 * @author VietTien
 */
public class View_LoaiXe extends javax.swing.JFrame {

    private final LoaiXeImpl XiLanh;

    public View_LoaiXe() {
        initComponents();
        setLocationRelativeTo(null);
        this.XiLanh = new LoaiXeImpl();
        this.LoadTable();
    }
    ...
    public void LoadTable() {
        ...
        dtm.setRowCount(0);
int stt=1;
        for (VM_LoaiXe x : XiLanh.getAllLX()) {
    ...
    public VM_LoaiXe getForm() {
        VM_LoaiXe kh = new VM_LoaiXe();
        kh.setId(txtId.getText());
        kh.setLaoiXe(txtXL.getText());
                        ...
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel7Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtXL, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE))))
...
//        txtXL.setText(tlbBang.getValueAt(row, 1).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_LoaiXe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new View_LoaiXe().setVisible(true);
            }
        });
    }
